...
export const CORE_SCHEMA_TABLES: { name: string; query: string }[] = [
  ...
  },
  {
    ...
    query: `CREATE TABLE IF NOT EXISTS tool_orchestrator (
        ...
        pricing_rule VARCHAR(50) DEFAULT 'standard'
      )`
  },
  {
  ...
  },
  {
    ...
    query: `CREATE TABLE IF NOT EXISTS subscriptions (
        ...
        plan_type VARCHAR(50) DEFAULT 'user',
  ...
  },
  {
    ...
    query: `CREATE TABLE IF NOT EXISTS system_settings (
        ...
        enable_crypto_payments BOOLEAN DEFAULT false,
        enable_stripe_payments BOOLEAN DEFAULT true,
        min_deposit_amount DECIMAL(10,2) DEFAULT 5,
        max_deposit_amount DECIMAL(10,2) DEFAULT 10000,
        referral_reward_amount DECIMAL(10,2) DEFAULT 5,
  ...
  },
  {
    ...
    query: `CREATE TABLE IF NOT EXISTS user_files (
        ...
        uploaded_by_role VARCHAR(50) DEFAULT 'user',
        metadata JSONB DEFAULT '{}',

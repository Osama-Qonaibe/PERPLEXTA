...
function walkDir(dir, callback) {
  ...
  for (const file of files) {
    ...
    if (stat.isDirectory()) {
      if (file !== 'node_modules' && file !== '.git' && file !== 'dist' && file !== 'workspace') {
...
console.log('Starting monochrome enforcement (JS)...');
...
console.log('Monochrome enforcement (JS) completed successfully.');

...
export const PWAInstall: React.FC<{ isSidebarOpen: boolean }> = ({ isSidebarOpen }) => {
  ...
  return (
    <AnimatePresence>
      ...
      >
        <div className="relative overflow-hidden rounded-[4px] border border-emerald-500/20 bg-emerald-500/5 p-4 group transition-all duration-500 hover:border-emerald-500/40">
          <div className="relative z-10">
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-2 text-emerald-500">
                <div className="p-1.5 rounded-[4px] bg-emerald-500/10">
                  <Smartphone size={16} />
                </div>
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 w-full py-2.5 px-4 rounded-[4px] bg-emerald-500 text-white text-[11px] font-bold shadow-lg shadow-emerald-500/20 hover:bg-emerald-600 hover:shadow-emerald-500/40 active:scale-[0.98] transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed group"
            >
              {isInstalling ? (
                <>
                  <motion.div

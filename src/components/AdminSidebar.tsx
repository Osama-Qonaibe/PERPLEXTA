...
export const AdminSidebar: React.FC<{ activeLanguage?: string }> = ({
  activeLanguage,
}) => {
  ...
  const navItems = [
    ...
    {
      icon: <Shield size={18} />,
      label: language === "ar" ? "رادار الأمان" : "Security Radar",
      path: "/admin/radar",
    },
    {
      icon: <Activity size={18} />,
      label:
        language === "ar" ? "مقاييس الأداء ورندر" : "Render & Latency Metrics",
      path: "/admin/metrics",
    },
    {
      icon: <Key size={18} />,
      label: t("aiInfrastructure"),
      path: "/admin/keys",
    },
    {
      icon: <Database size={18} />,
      label: t("dbOrchestration"),
      path: "/admin/databases",
    },
    {
      icon: <Cpu size={18} />,
      label: t("toolOrchestrator"),
      path: "/admin/orchestrator",
    },
    {
      icon: <Landmark size={18} />,
      label: t("financeVault"),
      path: "/admin/finance",
    },
    {
      icon: <Briefcase size={18} />,
      label: language === "ar" ? "لوحة الوكلاء" : "Agency Console",
      path: "/admin-agency",
    },
    {
      icon: <Cpu size={18} />,
    ...
    {
      icon: <Brain size={18} />,
      label: language === "ar" ? "مركز الذاكرة" : "Memory Center",
      path: "/admin/memories",
    },
    {
      icon: <Mail size={18} />,
      label: t("smartEmailHub"),
      path: "/admin/emails",
    },
    {
      icon: <Send size={18} />,
      label: t("smartBroadcast"),
    ...
    },
    {
      ...
      label: language === "ar" ? "التدقيق والامتثال" : "Compliance Audit",
      path: "/admin/audit",
    },
  ];
          ...
          >
            {({ isActive }) => (
              <>
                ...
                <span
                  className={`font-medium text-sm transition-colors ${isActive ? "text-accent" : ""}`}
                >
                  {item.label}
                </span>
              </>

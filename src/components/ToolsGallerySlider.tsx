        ...
        return (
          <div className="absolute inset-0 bg-gradient-to-br from-[#0c120f] to-[#121a16] flex flex-col items-center justify-center overflow-hidden">
            ...
            <svg className="w-10 h-10 text-emerald-500/80 drop-shadow-[0_0_8px_rgba(16,185,129,0.4)]" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <circle cx="32" cy="32" r="3" fill="currentColor" className="text-emerald-400" />
            </svg>
        ...
        return (
          <div className="absolute inset-0 bg-gradient-to-br from-[#0c1012] to-[#12161a] flex flex-col items-center justify-center overflow-hidden">
            ...
            <svg className="w-10 h-10 text-emerald-500/80 drop-shadow-[0_0_8px_rgba(16,185,129,0.4)]" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <polygon points="45,46 45,62 61,54" fill="currentColor" className="text-emerald-400" />
        ...
        return (
          <div className="absolute inset-0 bg-gradient-to-br from-[#0c1315] to-[#12191c] flex flex-col items-center justify-center overflow-hidden">
            ...
            <svg className="w-10 h-10 text-emerald-500/80" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <circle cx="38" cy="40" r="2" fill="currentColor" className="text-emerald-400" />
              <circle cx="52" cy="48" r="2" fill="currentColor" className="text-emerald-400" />

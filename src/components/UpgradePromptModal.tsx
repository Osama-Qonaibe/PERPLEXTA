...
const toolNameMap: Record<string, { en: string, ar: string }> = {
  ...
  learning: { en: 'Cognitive Adaptation Studio', ar: 'استوديو التكيف المعرفي والتعلم' },
...
const toolDescMap: Record<string, { en: string, ar: string }> = {
  ...
  learning: { en: 'Tailored cognitive systems for complex training mapping.', ar: 'أنظمة معرفية مصممة خصيصاً للتخطيط التدريبي والتعليمي المعقد.' },

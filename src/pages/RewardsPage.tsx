      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
        ...
        <div className={`relative overflow-hidden rounded-[4px] md:rounded-[4px] p-5 md:p-8 border bg-[var(--bg-secondary)] border-[var(--border-main)] flex flex-col items-center justify-center text-center min-h-[180px] md:min-h-[240px]`}>
          ...
          <div className="relative z-10 space-y-2 md:space-y-4">
            <h3 className="text-[11px] md:text-base text-gray-500 dark:text-gray-400 font-medium uppercase tracking-wider">{t('withdrawableBalance')}</h3>
        ...
        <div className={`relative overflow-hidden rounded-[4px] md:rounded-[4px] p-5 md:p-8 border bg-[var(--bg-secondary)] border-[var(--border-main)] flex flex-col items-center justify-center text-center min-h-[180px] md:min-h-[240px]`}>
          ...
          <div className="relative z-10 space-y-2 md:space-y-4">
            <h3 className="text-[11px] md:text-base text-gray-500 dark:text-gray-400 font-medium uppercase tracking-wider">{t('pointsBalance')}</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
        ...
        <div className={`rounded-[4px] md:rounded-[4px] p-5 md:p-8 border bg-[var(--bg-secondary)] border-[var(--border-main)]`}>
          ...
          <div className="space-y-6 md:space-y-8">
            ...
            <div className="flex items-start gap-3 md:gap-4">
              ...
              <div>
                <h4 className="font-bold text-[var(--text-primary)] text-base md:text-lg">{t('shareYourLink')}</h4>
                <p className="text-[11px] md:text-sm text-gray-500 dark:text-gray-400 mt-0.5 md:mt-1">{t('shareYourLinkDesc')}</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 md:gap-4">
              ...
              <div>
                <h4 className="font-bold text-[var(--text-primary)] text-base md:text-lg">{t('registration')}</h4>
                <p className="text-[11px] md:text-sm text-gray-500 dark:text-gray-400 mt-0.5 md:mt-1">{formatTranslation('registrationDesc')}</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 md:gap-4">
              ...
              <div>
                <h4 className="font-bold text-[var(--text-primary)] text-base md:text-lg">{t('activationAndProfit')}</h4>
                <p className="text-[11px] md:text-sm text-gray-500 dark:text-gray-400 mt-0.5 md:mt-1">{formatTranslation('activationAndProfitDesc')}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className={`rounded-[4px] md:rounded-[4px] p-5 md:p-8 border bg-[var(--bg-secondary)] border-[var(--border-main)] flex flex-col`}>
          <div className="text-center mb-6 md:mb-8">
            ...
            <p className="text-[11px] md:text-sm text-gray-500 dark:text-gray-400 mt-1.5 md:mt-2 max-w-sm mx-auto">
            ...
            <div className="space-y-1.5 md:space-y-2">
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  ...
                  <span className="hidden sm:inline text-xs md:text-sm">{copied ? t('copied') : t('copy')}</span>
                </button>
              </div>
            </div>
          ...
          {contextUser?.kyc_status === 'pending' ? (
            <div className="flex flex-col items-center text-center py-6 md:py-10 space-y-4 md:space-y-6">
              ...
              <div className="space-y-2 md:space-y-3 max-w-2xl px-2">
                ...
                <p className="text-[11px] md:text-base text-gray-500 dark:text-gray-400 leading-relaxed md:leading-relaxed">
                  {dir === 'rtl' 
              ...
              <div className={`mt-4 md:mt-8 p-4 md:p-6 rounded-[4px] md:rounded-[4px] border flex flex-col md:flex-row items-center gap-4 md:gap-6 max-w-3xl bg-[var(--bg-primary)]/50 border-[var(--border-main)]`}>
                ...
                <div className={`text-[10px] md:text-sm leading-relaxed ${dir === 'rtl' ? 'text-right' : 'text-left'}`}>
                  <p className="font-bold text-gray-900 dark:text-white mb-1.5 md:mb-2 text-xs md:text-sm">
                    {dir === 'rtl' ? 'التزامنا بالخصوصية والأمان (UK GDPR)' : 'Our Commitment to Privacy & Security (UK GDPR)'}
                  </p>
                  <p className="text-gray-500 dark:text-gray-400 opacity-80">
                    {dir === 'rtl'
            ...
            <div className="flex flex-col md:flex-row gap-6 md:gap-8">
              ...
              <div className="flex-1 space-y-4 md:space-y-6">
                <div className="flex items-center gap-3 md:gap-4">
                  ...
                  <div>
                    <div className="flex flex-wrap items-center gap-2 md:gap-3">
                      ...
                      <span className={`px-2 py-0.5 rounded-md text-[9px] md:text-xs font-bold border bg-[var(--bg-primary)]/50 border-[var(--border-main)] text-[var(--text-secondary)]`}>
                        {t('kycThresholdNote')}
                      </span>
                    </div>
                  </div>
                ...
                <p className="text-[11px] md:text-base text-gray-500 dark:text-gray-400 leading-relaxed">
                  {t('kycDescription')}
                </p>
                ...
                <div className="space-y-1.5 md:space-y-2">
                  ...
                  <div className={`relative flex items-center rounded-[4px] md:rounded-[4px] border transition-all ${
                    ...
                    <input 
                      ...
                      className={`w-full bg-transparent px-4 py-3 md:px-6 md:py-4 text-xs md:text-sm font-medium text-gray-900 dark:text-white focus:outline-none ${dir === 'rtl' ? 'text-right' : 'text-left'}`}
                      dir="auto"
                    />
                  </div>
                </div>
                    ...
                    <button 
                      ...
                      className={`w-full flex items-center justify-center gap-2 md:gap-3 py-3 md:py-4 rounded-[4px] md:rounded-[4px] border-2 border-dashed transition-all duration-300 ${
                        selfieCaptured 
                          ...
                          : theme === 'dark'
                            ? 'border-gray-700 hover:border-emerald-500/50 hover:bg-emerald-500/5 text-gray-400 hover:text-emerald-500'
                            : 'border-gray-300 hover:border-emerald-500/50 hover:bg-emerald-50/50 text-gray-500 hover:text-emerald-600'
                      }`}
                    >
                      {selfieCaptured ? (
                        <>
                ...
                <button 
                  ...
                  className={`w-full flex items-center justify-center gap-2 py-3 md:py-4 rounded-[4px] font-bold text-xs md:text-base transition-all duration-300 ${
                    !kycFullName.trim() || !selfieCaptured || isSubmitting
                      ...
                      : theme === 'dark'
                        ? 'bg-white text-gray-900 hover:bg-gray-100 shadow-[0_4px_20px_rgba(255,255,255,0.15)]'
      ...
      <div className="pt-4 md:pt-8 space-y-6 md:space-y-12">
        ...
        <div className="md:col-span-2">
          <div className="flex items-center justify-between mb-4 md:mb-6">
            <div className="flex items-center gap-2">
              <History className="text-gray-400 md:w-5 md:h-5" size={18} />
                  ...
                  {transactions.length === 0 ? (
                    ...
                    transactions.map((tx) => (
                      <tr key={tx.id} className={`border-b border-[var(--border-main)] hover:bg-[var(--bg-primary)]/20 transition-colors`}>
                        ...
                        <td className="px-6 py-4 text-gray-500 whitespace-nowrap">{tx.description}</td>
            ...
            <div className="space-y-1.5 md:space-y-2 mb-6 md:mb-8">
              ...
              <div className={`relative flex items-center rounded-[4px] md:rounded-[4px] border transition-all ${
                ...
                <input 
                  ...
                  className={`w-full bg-transparent px-4 py-3 md:px-6 md:py-4 text-[11px] md:text-sm font-medium text-gray-900 dark:text-white focus:outline-none ${dir === 'rtl' ? 'text-right' : 'text-left'}`}
                  dir="ltr"
                />
              </div>
            </div>

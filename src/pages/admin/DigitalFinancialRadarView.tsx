...
import { 
  Landmark, ArrowRightLeft, History, Zap, Search, RefreshCw, 
  Trash2, Shield, AlertCircle, CheckCircle, X, ShieldAlert,
  ShieldCheck, CheckCircle2, TrendingUp
} from "lucide-react";
import { motion, AnimatePresence } from "motion/react";
import { useAppContext } from "../../context/AppContext";
import { getTimeAgo } from "../../utils/timeAgo";
import { RadarStats, FinancialTransaction } from "../../types/admin.types";

export const DigitalFinancialRadarView = ({
  theme,
  t,
}: {
  theme: string;
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      if (financeRes.ok) {
        const data = await financeRes.ok ? await financeRes.json() : { transactions: [], stats: null };

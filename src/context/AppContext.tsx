...
const translations = {
  ar: {
    ...
    localConnectionStringTitle: 'رابط قاعدة البيانات المحلية (Connection URI)',
    localConnectionStringDesc: 'يمكنك كتابة أو لصق رابط الاتصال المباشر (مثل: postgresql://postgres:password@localhost:5432/platform_core) للربط الفوري والتزامن التلقائي.',
    fillDefaultLocalUri: 'توليد رابط محلي افتراضي',
    localConnectionModeUrl: 'رابط مباشر (URI)',
    localConnectionModeFields: 'الحقول التفصيلية',
    localContainerHint: 'تلميح الاتصال المحلي: إذا كان التطبيق يعمل داخل حاوية وقاعدة البيانات على جهازك المضيف، استخدم عنوان IP جهازك أو نفق محلي (Tunnel) أو رابط سحابي، حيث أن localhost يشير لداخل الحاوية نفسها.',
    dbTestRunning: 'جاري فحص الاتصال وقراءة الاستجابة...',
    copyUriSuccess: 'تم نسخ الرابط بنجاح',
  ...
  en: {
    ...
    localConnectionStringTitle: 'Local Database Connection URI',
    localConnectionStringDesc: 'Enter or paste a direct connection URI (e.g. postgresql://postgres:password@localhost:5432/platform_core) for instant setup and auto-sync.',
    fillDefaultLocalUri: 'Generate Default Local URI',
    localConnectionModeUrl: 'Direct URI',
    localConnectionModeFields: 'Individual Fields',
    localContainerHint: 'Local Connection Tip: If the app runs in a container and your database is on your host machine, use your host IP, a local tunnel, or a cloud URI, as localhost resolves inside the container.',
    dbTestRunning: 'Testing connection and verifying reachability...',
    copyUriSuccess: 'Connection URI copied successfully',
